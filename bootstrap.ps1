...
#     exit 1
# }
$folderName = "phoenix-testing-api"
...
if (!($org = Read-Host "Enter organization [$default]")) { $org = $default }
if (!($token = Read-Host "Enter token")) { $token = "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" }
